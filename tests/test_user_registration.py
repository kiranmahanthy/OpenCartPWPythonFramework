...
def test_user_registration(page):
    ...
    #registration_data = {"first_name": first_name, "last_name": last_name, "email": email, "password": password}
    #registration_page.complete_registration(registration_data)
    ...
    registration_page.subscribe_newsletter(True)
