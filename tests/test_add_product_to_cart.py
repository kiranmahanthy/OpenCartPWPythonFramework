...
def test_add_product_to_cart(page):
    ...
    # select product method from SearchResultsPage will return a newly created page called Product Page
    # Hence we are not creating an instance/constructor for Product page separately
